...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.linear_relu_stack = nn.Sequential(
            ...
            nn.Linear(128, 64),
            nn.ReLU(),
            nn.Linear(64, 2)  # Inget dropout på sista lagret
)
...
class NeuralModel:
    ...
    def retrain_with_k_fold(self, train_df: pd.DataFrame, k=10, epochs=100, patience=15):
        ...
        # Spara till CSV-fil
        csv_save_path = '../models/feed_forward_protein_kfold_metrics.csv'
