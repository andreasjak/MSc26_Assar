...
class CNNNetwork(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool1d(2),
            nn.Conv1d(2, 2, kernel_size=5, padding=2),
            nn.ReLU(),
            nn.MaxPool1d(2),
            nn.Conv1d(2, 2, kernel_size=7, padding=3),
            nn.ReLU()
        )
...
class CNNModel:
    def __init__(self,
                 model_path='../models/cnn_tiny.pth',
    ...
    def retrain_with_k_fold(self, train_df: pd.DataFrame, k=10, epochs=100, patience=15):
        ...
        # Spara till CSV-fil
        csv_save_path = '../models/cnn_tiny_kfold_metrics.csv'
