...
class CNNModel:
    def __init__(self,
                 model_path='../models/convolution_dilated_version_no_proteins.pth',
                 scaler_path='../models/scaler_no_proteins.pkl'):
    ...
    def retrain_with_k_fold(self, train_df: pd.DataFrame, k=10, epochs=100, patience=15):
        ...
        # Spara till CSV-fil
        csv_save_path = '../models/cnn_dilated_convolutions_no_proteins_kfold_metrics.csv'
...
def build_dataloaders(train_rows, val_rows, test_rows, batch_sz=512):
    ...
    joblib.dump(scaler, '../models/scaler_no_proteins.pkl')
